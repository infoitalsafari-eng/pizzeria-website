...
- [Supabase migration Pizzeria Chez Moi](supabase-migration.md) — tables créées, 325 produits migrés, compte admin créé ; Stage 3 = brancher le frontend sur Supabase
